...
void LibraryFunctions::addBook(vector<Book>& books) { //takes reference to the vector books
    ...
    //
    const string genres[] = { "Fiction", "Non-Fiction", "Mystery", "Sci-Fi", "Fantasy", "Biography", "History", "Children","Bible"};
    //predefined array list for genre so thes are the only options 
